...
export const IconWrapper = styled.div`
  ...
  `}
`
//overflow-y é o scroll para mobile, se a tela for grande não irá aparecer
...
//é a camada branca, inicia escondida (opacidade)
//dentro do wrapper será editado para ela mudar a opacidade e aparecer
...
//& > div:not(:last-of-type) { = serve para não colocar margem no último item
